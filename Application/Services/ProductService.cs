...
namespace HighSens.Application.Services
{
    ...
    {
        private readonly HighSens.Application.Interfaces.IRepositories.IProductRepository _repo;
        private readonly HighSens.Domain.Interfaces.IUnitOfWork _uow;

        public ProductService(HighSens.Application.Interfaces.IRepositories.IProductRepository repo, HighSens.Domain.Interfaces.IUnitOfWork uow)
        {
            _repo = repo;
            _uow = uow;
        }
